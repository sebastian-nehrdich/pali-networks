    ...
    return html`
      ...
      <div id="home">
	      ...
	      <ul>
		      ...
		      <li>Text-view shows the full text of the chosen text with the parallels in a separate frame when a segment is clicked. A third frame shows the corresponding text.</li>
