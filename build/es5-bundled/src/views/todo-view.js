...
*/'use strict';Object.defineProperty(_exports,"__esModule",{value:!0});_exports.$documentWaitDefault=documentWait;_exports.addListener=addListener;_exports.afterNextRender=afterNextRender;_exports.applyCss=applyCss;_exports.applyStyle=applyStyle;_exports.applyStylePlaceHolder=applyStylePlaceHolder;_exports.beforeNextRender=beforeNextRender;_exports.calculateSplices=calculateSplices;_exports.camelToDashCase=camelToDashCase;_exports.createScopeStyle=createScopeStyle;_exports.cssFromModule=cssFromModule;_exports.cssFromModuleImports=cssFromModuleImports;_exports.cssFromModules=cssFromModules;_exports.cssFromTemplate=cssFromTemplate;_exports.dashToCamelCase=dashToCamelCase;_exports.deepTargetFind=deepTargetFind;_exports.detectMixin=_detectMixin;_exports.dumpRegistrations=dumpRegistrations;_exports.elementHasBuiltCss=elementHasBuiltCss;_exports.elementsAreInvalid=elementsAreInvalid;_exports.findMatchingParen=findMatchingParen;_exports.flush$2=flush;_exports.forEachRule=forEachRule;_exports.gatherStyleText=gatherStyleText;_exports.get=_get;_exports.getBuildComment=getBuildComment;_exports.getComputedStyleValue=_getComputedStyleValue;_exports.getCssBuild=getCssBuild;_exports.getIsExtends=getIsExtends;_exports.incrementInstanceCount=incrementInstanceCount;_exports.insertNodeIntoTemplate=insertNodeIntoTemplate;_exports.invalidate=invalidate;_exports.invalidateTemplate=invalidateTemplate;_exports.isAncestor=isAncestor;_exports.isDescendant=isDescendant;_exports.isKeyframesSelector=isKeyframesSelector;_exports.isOptimalCssBuild=isOptimalCssBuild;_exports.isPath=isPath;_exports.isTargetedBuild=isTargetedBuild;_exports.isUnscopedStyle=isUnscopedStyle;_exports.isValid=isValid;_exports.isValidating=isValidating;_exports.matches=matches;_exports.mixinBehaviors=mixinBehaviors;_exports.modelForElement=_modelForElement;_exports.normalize=normalize;_exports.parse=parse;_exports.pathFromUrl=pathFromUrl;_exports.prevent=_prevent;_exports.processUnscopedStyle=processUnscopedStyle;_exports.processVariableAndFallback=processVariableAndFallback;_exports.property$1=_exports.property=property;_exports.query$1=_exports.query=query;_exports.queryAll$1=_exports.queryAll=queryAll;_exports.register=register$1;_exports.register$1=register;_exports.removeCustomPropAssignment=removeCustomPropAssignment;_exports.removeListener=removeListener;_exports.removeNodesFromTemplate=removeNodesFromTemplate;_exports.resetMouseCanceller=resetMouseCanceller;_exports.resolveCss=resolveCss;_exports.resolveUrl=_resolveUrl;_exports.root=root;_exports.rulesForStyle=rulesForStyle;_exports.set=_set;_exports.setElementClassRaw=setElementClassRaw;_exports.setTouchAction=setTouchAction;_exports.split=split;_exports.splitSelectorList=splitSelectorList;_exports.startValidating=startValidating;_exports.startValidatingTemplate=startValidatingTemplate;_exports.stringify=stringify;_exports.stylesFromModule=stylesFromModule;_exports.stylesFromModuleImports=stylesFromModuleImports;_exports.stylesFromModules=stylesFromModules;_exports.stylesFromTemplate=stylesFromTemplate;_exports.templateFactory$1=_exports.templateFactory=templateFactory;_exports.templateIsValid=templateIsValid;_exports.templateIsValidating=templateIsValidating;_exports.templatize=_templatize;_exports.toCssText=toCssText;_exports.translate=translate;_exports.updateNativeProperties=updateNativeProperties;_exports.CustomStyleProvider=_exports.CustomStyleInterfaceInterface=_exports.CustomStyle=_exports.ControlStateMixin=_exports.Class=_exports.CSSResult$1=_exports.CSSResult=_exports.BooleanAttributePart$1=_exports.BooleanAttributePart=_exports.Base=_exports.BRACKETED=_exports.AttributePart$1=_exports.AttributePart=_exports.AttributeCommitter$1=_exports.AttributeCommitter=_exports.ArraySelectorMixin=_exports.ArraySelector=_exports.ANIMATION_MATCH=_exports.$wrap=_exports.$version=_exports.$vaadinUsageStatistics=_exports.$vaadinThemePropertyMixin=_exports.$vaadinThemableMixin=_exports.$vaadinTextFieldMixin=_exports.$vaadinTextField=_exports.$vaadinRadioGroup=_exports.$vaadinRadioButton=_exports.$vaadinElementMixin=_exports.$vaadinDevelopmentModeDetector=_exports.$vaadinControlStateMixin=_exports.$updatingElement=_exports.$unscopedStyleHandler=_exports.$templatizerBehavior=_exports.$templatize=_exports.$templateStamp=_exports.$templateResult=_exports.$templateMapDefault=_exports.$templateMap=_exports.$templateInstance=_exports.$templateFactory=_exports.$template=_exports.$telemetry=_exports.$styleUtil=_exports.$styleSettings=_exports.$styleGather=_exports.$shadyRender=_exports.$settings=_exports.$resolveUrl=_exports.$renderStatus=_exports.$render=_exports.$propertyEffects=_exports.$propertyAccessors=_exports.$propertiesMixin=_exports.$propertiesChanged=_exports.$polymerLegacy=_exports.$polymerFn=_exports.$polymerElement=_exports.$polymerDom=_exports.$path=_exports.$parts=_exports.$part=_exports.$mutableDataBehavior=_exports.$mutableData=_exports.$modifyTemplate=_exports.$mixin=_exports.$litHtml=_exports.$litElement=_exports.$legacyElementMixin=_exports.$htmlTag=_exports.$gestures=_exports.$gestureEventListeners=_exports.$flush=_exports.$flattenedNodesObserver=_exports.$elementMixin=_exports.$domRepeat=_exports.$domModule=_exports.$domIf=_exports.$domBind=_exports.$dom=_exports.$documentWait=_exports.$directive=_exports.$dirMixin=_exports.$defaultTemplateProcessor=_exports.$decorators=_exports.$debounce=_exports.$customStyleInterfaceDefault=_exports.$customStyleInterface$1=_exports.$customStyle=_exports.$cssTag=_exports.$cssParse=_exports.$commonUtils=_exports.$commonRegex=_exports.$class=_exports.$caseMap=_exports.$async=_exports.$arraySplice=_exports.$arraySelector=_exports.$applyShimUtils=_exports.$applyShimDefault=_exports.$applyShim$1=void 0;_exports.html$3=_exports.html$2=_exports.html$1=_exports.html=_exports.gestures=_exports.flushDebouncers=_exports.flush$1=_exports.flush=_exports.findOriginalTarget=_exports.eventOptions$1=_exports.eventOptions=_exports.dom=_exports.disableRuntime=_exports.directive$1=_exports.directive=_exports.defaultTemplateProcessor$1=_exports.defaultTemplateProcessor=_exports.defaultConverter$1=_exports.defaultConverter=_exports.dedupingMixin=_exports.customElement$1=_exports.customElement=_exports.cssBuild=_exports.css$1=_exports.css=_exports.createMarker$1=_exports.createMarker=_exports.boundAttributeSuffix=_exports.animationFrame=_exports.allowTemplateFromDomModule=_exports.enqueueDebouncer$1=_exports.enqueueDebouncer=_exports.addDebouncer=_exports.add=_exports.VAR_CONSUMED=_exports.VAR_ASSIGN=_exports.UpdatingElement$1=_exports.UpdatingElement=_exports.ThemePropertyMixin=_exports.ThemableMixin=_exports.TextFieldMixin=_exports.TextFieldElement=_exports.Templatizer=_exports.TemplateStamp=_exports.TemplateResult$3=_exports.TemplateResult$2=_exports.TemplateResult$1=_exports.TemplateResult=_exports.TemplateInstanceBase=_exports.TemplateInstance$1=_exports.TemplateInstance=_exports.Template$1=_exports.Template=_exports.StyleNode=_exports.SVGTemplateResult$2=_exports.SVGTemplateResult$1=_exports.SVGTemplateResult=_exports.RadioGroupElement=_exports.RadioButtonElement=_exports.PropertyPart$1=_exports.PropertyPart=_exports.PropertyEffects=_exports.PropertyCommitter$1=_exports.PropertyCommitter=_exports.PropertyAccessors=_exports.PropertiesMixin=_exports.PropertiesChanged=_exports.PolymerElement=_exports.Polymer$1=_exports.Polymer=_exports.OptionalMutableDataBehavior=_exports.OptionalMutableData=_exports.NodePart$1=_exports.NodePart=_exports.MutableDataBehavior=_exports.MutableData=_exports.MIXIN_MATCH=_exports.MEDIA_MATCH=_exports.Lumo=_exports.LitElement=_exports.LegacyElementMixin=_exports.IS_VAR=_exports.HOST_SUFFIX=_exports.HOST_PREFIX=_exports.GestureEventListeners=_exports.FlattenedNodesObserver=_exports.EventPart$1=_exports.EventPart=_exports.EventApi=_exports.ElementMixin$1=_exports.ElementMixin=_exports.DomRepeat=_exports.DomModule=_exports.DomIf=_exports.DomBind=_exports.DomApi=_exports.DirMixin=_exports.DefaultTemplateProcessor$1=_exports.DefaultTemplateProcessor=_exports.Debouncer=void 0;_exports.wrap$1=_exports.wrap=_exports.version$1=_exports.version=_exports.useShadow=_exports.useNativeCustomElements=_exports.useNativeCSSProperties=_exports.usageStatistics=_exports.updateStyles=_exports.unsafeCSS$1=_exports.unsafeCSS=_exports.types=_exports.timeOut=_exports.templateCaches$1=_exports.templateCaches=_exports.syncInitialRender=_exports.svg$2=_exports.svg$1=_exports.svg=_exports.supportsAdoptingStyleSheets$1=_exports.supportsAdoptingStyleSheets=_exports.strictTemplatePolicy=_exports.setSyncInitialRender=_exports.setStrictTemplatePolicy=_exports.setSanitizeDOMValue=_exports.setRootPath=_exports.setPassiveTouchGestures=_exports.setLegacyOptimizations=_exports.setAllowTemplateFromDomModule=_exports.scopingAttribute=_exports.sanitizeDOMValue=_exports.runIfDevelopmentMode=_exports.rootPath=_exports.reparentNodes$1=_exports.reparentNodes=_exports.render$1=_exports.render$2=_exports.render=_exports.removeNodes$1=_exports.removeNodes=_exports.remove=_exports.registrations=_exports.recognizers=_exports.passiveTouchGestures=_exports.parts$1=_exports.parts=_exports.nothing$1=_exports.nothing=_exports.notEqual$1=_exports.notEqual=_exports.nodeMarker=_exports.noChange$1=_exports.noChange=_exports.nativeShadow=_exports.nativeCssVariables=_exports.microTask=_exports.matchesSelector=_exports.markerRegex=_exports.marker=_exports.legacyOptimizations=_exports.lastAttributeNameRegex=_exports.isTemplatePartActive$1=_exports.isTemplatePartActive=_exports.isPrimitive$1=_exports.isPrimitive=_exports.isDirective$1=_exports.isDirective=_exports.isDeep=_exports.isCEPolyfill=_exports.instanceCount=_exports.idlePeriod=_exports.htmlLiteral=_exports.html$5=_exports.html$4=void 0;meta=babelHelpers.interopRequireWildcard(meta);function _templateObject16_b3f198a064f911e99435bfcd8e03834f(){var data=babelHelpers.taggedTemplateLiteral(["","\n        <td class=\"segment-header\">\n          ","\n        </td>"]);_templateObject16_b3f198a064f911e99435bfcd8e03834f=function _templateObject16_b3f198a064f911e99435bfcd8e03834f(){return data};return data}function _templateObject15_b3f198a064f911e99435bfcd8e03834f(){var data=babelHelpers.taggedTemplateLiteral(["","\n          <a href=\"https://suttacentral.net/","/pli/ms#","\" target=\"_blank\">",":","</a>\n          <br>"]);_templateObject15_b3f198a064f911e99435bfcd8e03834f=function _templateObject15_b3f198a064f911e99435bfcd8e03834f(){return data};return data}function _templateObject14_b3f198a064f911e99435bfcd8e03834f(){var data=babelHelpers.taggedTemplateLiteral(["","\n        <td>\n          ","\n        </td>"]);_templateObject14_b3f198a064f911e99435bfcd8e03834f=function _templateObject14_b3f198a064f911e99435bfcd8e03834f(){return data};return data}function _templateObject13_b3f198a064f911e99435bfcd8e03834f(){var data=babelHelpers.taggedTemplateLiteral(["","\n        <tr>\n            <td>\n              <a href=\"https://suttacentral.net/","/pli/ms#","\" target=\"_blank\">","</a>\n            </td>\n            ","\n        </tr>\n      "]);_templateObject13_b3f198a064f911e99435bfcd8e03834f=function _templateObject13_b3f198a064f911e99435bfcd8e03834f(){return data};return data}function _templateObject12_b3f198a064f911e99435bfcd8e03834f(){var data=babelHelpers.taggedTemplateLiteral(["","\n      <tr><td colspan=\"20\">Parallel segment numbers sorted by collection.<br>\n        Click on the segment numbers to go to the relevant section in SuttaCentral.<br>\n        When there is a range of parallel segment numbers, only the first one is shown.\n      </td></tr>\n      <tr>\n          <td class=\"start-segment-nr segment-header\">\n            Segment Number in ","\n          </td>\n          ","\n      </tr>\n    "]);_templateObject12_b3f198a064f911e99435bfcd8e03834f=function _templateObject12_b3f198a064f911e99435bfcd8e03834f(){return data};return data}function _templateObject11_b3f198a064f911e99435bfcd8e03834f(){var data=babelHelpers.taggedTemplateLiteral(["","\n        <tr>\n          <tr>\n            <td class=\"start-segment\" rowspan=\"","\">\n              <a href=\"https://suttacentral.net/","/pli/ms#","\" target=\"_blank\">","</a><br>","\n            </td>\n          </tr>\n          ","\n        </tr>\n      "]);_templateObject11_b3f198a064f911e99435bfcd8e03834f=function _templateObject11_b3f198a064f911e99435bfcd8e03834f(){return data};return data}function _templateObject10_b3f198a064f911e99435bfcd8e03834f(){var data=babelHelpers.taggedTemplateLiteral(["","\n            <tr>\n              <td>\n                <a href=\"https://suttacentral.net/","/pli/ms#","\" target=\"_blank\">","</a><br>\n                Probability: ","<br>\n                ","\n              </td>\n            </tr>\n        "]);_templateObject10_b3f198a064f911e99435bfcd8e03834f=function _templateObject10_b3f198a064f911e99435bfcd8e03834f(){return data};return data}function _templateObject9_b3f198a064f911e99435bfcd8e03834f(){var data=babelHelpers.taggedTemplateLiteral(["","\n      <tr><td colspan=\"2\">Parallel segments for each segment in ",".<br>\n        The lower the probability number, the better the match.<br>\n        Click on the segment numbers to go to the relevant section in SuttaCentral.<br>\n        When there is a range of parallel segment numbers, only the first one is shown.\n      </td></tr>\n      <tr>\n          <td class=\"start-segment segment-header\">\n            Segment Number in ","\n          </td>\n          <td class=\"segment-header\">\n            Parallel segments and probabilities.\n          </td>\n      </tr>\n    "]);_templateObject9_b3f198a064f911e99435bfcd8e03834f=function _templateObject9_b3f198a064f911e99435bfcd8e03834f(){return data};return data}function _templateObject8_b3f198a064f911e99435bfcd8e03834f(){var data=babelHelpers.taggedTemplateLiteral(["\n              <vaadin-radio-button value=\"","\">\n                ","\n              </vaadin-radio-button>"]);_templateObject8_b3f198a064f911e99435bfcd8e03834f=function _templateObject8_b3f198a064f911e99435bfcd8e03834f(){return data};return data}function _templateObject7_b3f198a064f911e99435bfcd8e03834f(){var data=babelHelpers.taggedTemplateLiteral([" \n\n      <style>\n\n        .start-segment {\n          padding-right: 10px;\n          width: 30%;\n        }\n\n        .start-segment.nr {\n          width: 10%;\n        }\n\n        .segment-header {\n          font-weight: bold;\n        }\n\n        td {\n          vertical-align: top;\n          border: 1px solid black;\n          font-family: sans-serif;\n        }\n\n      </style>\n\n      <div class=\"input-layout\"\n  \t\t  @keyup=\"","\"> \n\n  \t\t  <vaadin-text-field\n  \t\t    placeholder=\"Sutta Number\"\n  \t\t    value=\"","\" \n          @change=\"","\"> \n  \t\t  </vaadin-text-field>\n\n        <vaadin-radio-group\n          class=\"visibility-filters\"\n          value=\"","\"\n          @value-changed=\"","\"> \n\n          ","\n        </vaadin-radio-group>\n  \t\t</div>\n\n      <table>\n        ","\n\n      </table>\n    "]);_templateObject7_b3f198a064f911e99435bfcd8e03834f=function _templateObject7_b3f198a064f911e99435bfcd8e03834f(){return data};return data}function _templateObject6_b3f198a064f911e99435bfcd8e03834f(){var data=babelHelpers.taggedTemplateLiteral(["<dom-module id=\"lumo-text-field\" theme-for=\"vaadin-text-field\">\n  <template>\n    <style include=\"lumo-required-field lumo-field-button\">\n      :host {\n        --lumo-text-field-size: var(--lumo-size-m);\n        color: var(--lumo-body-text-color);\n        font-size: var(--lumo-font-size-m);\n        font-family: var(--lumo-font-family);\n        -webkit-font-smoothing: antialiased;\n        -moz-osx-font-smoothing: grayscale;\n        -webkit-tap-highlight-color: transparent;\n        padding: var(--lumo-space-xs) 0;\n      }\n\n      :host::before {\n        height: var(--lumo-text-field-size);\n        box-sizing: border-box;\n        display: inline-flex;\n        align-items: center;\n      }\n\n      :host([focused]:not([readonly])) [part=\"label\"] {\n        color: var(--lumo-primary-text-color);\n      }\n\n      [part=\"value\"],\n      [part=\"input-field\"] ::slotted(input),\n      [part=\"input-field\"] ::slotted(textarea),\n      /* Slotted by vaadin-select-text-field */\n      [part=\"input-field\"] ::slotted([part=\"value\"]) {\n        cursor: inherit;\n        min-height: var(--lumo-text-field-size);\n        padding: 0 0.25em;\n        --_lumo-text-field-overflow-mask-image: linear-gradient(to left, transparent, #000 1.25em);\n        -webkit-mask-image: var(--_lumo-text-field-overflow-mask-image);\n      }\n\n      [part=\"value\"]:focus,\n      [part=\"input-field\"] ::slotted(input):focus,\n      [part=\"input-field\"] ::slotted(textarea):focus {\n        -webkit-mask-image: none;\n        mask-image: none;\n      }\n\n      /*\n        TODO: CSS custom property in `mask-image` causes crash in Edge\n        see https://developer.microsoft.com/en-us/microsoft-edge/platform/issues/15415089/\n      */\n      @-moz-document url-prefix() {\n        [part=\"value\"],\n        [part=\"input-field\"] ::slotted(input),\n        [part=\"input-field\"] ::slotted(textarea),\n        [part=\"input-field\"] ::slotted([part=\"value\"]) {\n          mask-image: var(--_lumo-text-field-overflow-mask-image);\n        }\n      }\n\n      [part=\"value\"]::-webkit-input-placeholder {\n        color: inherit;\n        transition: opacity 0.175s 0.05s;\n        opacity: 0.5;\n      }\n\n      [part=\"value\"]:-ms-input-placeholder {\n        color: inherit;\n        opacity: 0.5;\n      }\n\n      [part=\"value\"]::-moz-placeholder {\n        color: inherit;\n        transition: opacity 0.175s 0.05s;\n        opacity: 0.5;\n      }\n\n      [part=\"value\"]::placeholder {\n        color: inherit;\n        transition: opacity 0.175s 0.1s;\n        opacity: 0.5;\n      }\n\n      [part=\"input-field\"] {\n        border-radius: var(--lumo-border-radius);\n        background-color: var(--lumo-contrast-10pct);\n        padding: 0 calc(0.375em + var(--lumo-border-radius) / 4 - 1px);\n        font-weight: 500;\n        line-height: 1;\n        position: relative;\n        cursor: text;\n        box-sizing: border-box;\n      }\n\n      /* Used for hover and activation effects */\n      [part=\"input-field\"]::after {\n        content: \"\";\n        position: absolute;\n        top: 0;\n        right: 0;\n        bottom: 0;\n        left: 0;\n        border-radius: inherit;\n        pointer-events: none;\n        background-color: var(--lumo-contrast-50pct);\n        opacity: 0;\n        transition: transform 0.15s, opacity 0.2s;\n        transform-origin: 100% 0;\n      }\n\n      /* Hover */\n\n      :host(:hover:not([readonly]):not([focused])) [part=\"label\"] {\n        color: var(--lumo-body-text-color);\n      }\n\n      :host(:hover:not([readonly]):not([focused])) [part=\"input-field\"]::after {\n        opacity: 0.1;\n      }\n\n      /* Touch device adjustment */\n      @media (pointer: coarse) {\n        :host(:hover:not([readonly]):not([focused])) [part=\"label\"] {\n          color: var(--lumo-secondary-text-color);\n        }\n\n        :host(:hover:not([readonly]):not([focused])) [part=\"input-field\"]::after {\n          opacity: 0;\n        }\n\n        :host(:active:not([readonly]):not([focused])) [part=\"input-field\"]::after {\n          opacity: 0.2;\n        }\n      }\n\n      /* Trigger when not focusing using the keyboard */\n      :host([focused]:not([focus-ring]):not([readonly])) [part=\"input-field\"]::after {\n        transform: scaleX(0);\n        transition-duration: 0.15s, 1s;\n      }\n\n      /* Focus-ring */\n\n      :host([focus-ring]) [part=\"input-field\"] {\n        box-shadow: 0 0 0 2px var(--lumo-primary-color-50pct);\n      }\n\n      /* Read-only and disabled */\n      :host([readonly]) [part=\"value\"]::-webkit-input-placeholder,\n      :host([disabled]) [part=\"value\"]::-webkit-input-placeholder {\n        opacity: 0;\n      }\n\n      :host([readonly]) [part=\"value\"]:-ms-input-placeholder,\n      :host([disabled]) [part=\"value\"]:-ms-input-placeholder {\n        opacity: 0;\n      }\n\n      :host([readonly]) [part=\"value\"]::-moz-placeholder,\n      :host([disabled]) [part=\"value\"]::-moz-placeholder {\n        opacity: 0;\n      }\n\n      :host([readonly]) [part=\"value\"]::placeholder,\n      :host([disabled]) [part=\"value\"]::placeholder {\n        opacity: 0;\n      }\n\n      /* Read-only */\n\n      :host([readonly]) [part=\"input-field\"] {\n        color: var(--lumo-secondary-text-color);\n        background-color: transparent;\n        cursor: default;\n      }\n\n      :host([readonly]) [part=\"input-field\"]::after {\n        background-color: transparent;\n        opacity: 1;\n        border: 1px dashed var(--lumo-contrast-30pct);\n      }\n\n      /* Disabled style */\n\n      :host([disabled]) {\n        pointer-events: none;\n      }\n\n      :host([disabled]) [part=\"input-field\"] {\n        background-color: var(--lumo-contrast-5pct);\n      }\n\n      :host([disabled]) [part=\"label\"],\n      :host([disabled]) [part=\"value\"],\n      :host([disabled]) [part=\"input-field\"] ::slotted(*) {\n        color: var(--lumo-disabled-text-color);\n        -webkit-text-fill-color: var(--lumo-disabled-text-color);\n      }\n\n      /* Invalid style */\n\n      :host([invalid]) [part=\"input-field\"] {\n        background-color: var(--lumo-error-color-10pct);\n      }\n\n      :host([invalid]) [part=\"input-field\"]::after {\n        background-color: var(--lumo-error-color-50pct);\n      }\n\n      :host([invalid][focus-ring]) [part=\"input-field\"] {\n        box-shadow: 0 0 0 2px var(--lumo-error-color-50pct);\n      }\n\n      :host([input-prevented]) [part=\"input-field\"] {\n        color: var(--lumo-error-text-color);\n      }\n\n      /* Small theme */\n\n      :host([theme~=\"small\"]) {\n        font-size: var(--lumo-font-size-s);\n        --lumo-text-field-size: var(--lumo-size-s);\n      }\n\n      :host([theme~=\"small\"][has-label]) [part=\"label\"] {\n        font-size: var(--lumo-font-size-xs);\n      }\n\n      :host([theme~=\"small\"][has-label]) [part=\"error-message\"] {\n        font-size: var(--lumo-font-size-xxs);\n      }\n\n      /* Text align */\n\n      :host([theme~=\"align-center\"]) [part=\"value\"] {\n        text-align: center;\n        --_lumo-text-field-overflow-mask-image: none;\n      }\n\n      :host([theme~=\"align-right\"]) [part=\"value\"] {\n        text-align: right;\n        --_lumo-text-field-overflow-mask-image: none;\n      }\n\n      @-moz-document url-prefix() {\n        /* Firefox is smart enough to align overflowing text to right */\n        :host([theme~=\"align-right\"]) [part=\"value\"] {\n          --_lumo-text-field-overflow-mask-image: linear-gradient(to right, transparent 0.25em, #000 1.5em);\n        }\n      }\n\n      /* Slotted content */\n\n      [part=\"input-field\"] ::slotted(:not([part]):not(iron-icon):not(input):not(textarea)) {\n        color: var(--lumo-secondary-text-color);\n        font-weight: 400;\n      }\n\n      /* Slotted icons */\n\n      [part=\"input-field\"] ::slotted(iron-icon) {\n        color: var(--lumo-contrast-60pct);\n        width: var(--lumo-icon-size-m);\n        height: var(--lumo-icon-size-m);\n      }\n\n      /* Vaadin icons are based on a 16x16 grid (unlike Lumo and Material icons with 24x24), so they look too big by default */\n      [part=\"input-field\"] ::slotted(iron-icon[icon^=\"vaadin:\"]) {\n        padding: 0.25em;\n        box-sizing: border-box !important;\n      }\n\n      [part=\"clear-button\"]::before {\n        content: var(--lumo-icons-cross);\n      }\n    </style>\n  </template>\n</dom-module>"],["<dom-module id=\"lumo-text-field\" theme-for=\"vaadin-text-field\">\n  <template>\n    <style include=\"lumo-required-field lumo-field-button\">\n      :host {\n        --lumo-text-field-size: var(--lumo-size-m);\n        color: var(--lumo-body-text-color);\n        font-size: var(--lumo-font-size-m);\n        font-family: var(--lumo-font-family);\n        -webkit-font-smoothing: antialiased;\n        -moz-osx-font-smoothing: grayscale;\n        -webkit-tap-highlight-color: transparent;\n        padding: var(--lumo-space-xs) 0;\n      }\n\n      :host::before {\n        height: var(--lumo-text-field-size);\n        box-sizing: border-box;\n        display: inline-flex;\n        align-items: center;\n      }\n\n      :host([focused]:not([readonly])) [part=\"label\"] {\n        color: var(--lumo-primary-text-color);\n      }\n\n      [part=\"value\"],\n      [part=\"input-field\"] ::slotted(input),\n      [part=\"input-field\"] ::slotted(textarea),\n      /* Slotted by vaadin-select-text-field */\n      [part=\"input-field\"] ::slotted([part=\"value\"]) {\n        cursor: inherit;\n        min-height: var(--lumo-text-field-size);\n        padding: 0 0.25em;\n        --_lumo-text-field-overflow-mask-image: linear-gradient(to left, transparent, #000 1.25em);\n        -webkit-mask-image: var(--_lumo-text-field-overflow-mask-image);\n      }\n\n      [part=\"value\"]:focus,\n      [part=\"input-field\"] ::slotted(input):focus,\n      [part=\"input-field\"] ::slotted(textarea):focus {\n        -webkit-mask-image: none;\n        mask-image: none;\n      }\n\n      /*\n        TODO: CSS custom property in \\`mask-image\\` causes crash in Edge\n        see https://developer.microsoft.com/en-us/microsoft-edge/platform/issues/15415089/\n      */\n      @-moz-document url-prefix() {\n        [part=\"value\"],\n        [part=\"input-field\"] ::slotted(input),\n        [part=\"input-field\"] ::slotted(textarea),\n        [part=\"input-field\"] ::slotted([part=\"value\"]) {\n          mask-image: var(--_lumo-text-field-overflow-mask-image);\n        }\n      }\n\n      [part=\"value\"]::-webkit-input-placeholder {\n        color: inherit;\n        transition: opacity 0.175s 0.05s;\n        opacity: 0.5;\n      }\n\n      [part=\"value\"]:-ms-input-placeholder {\n        color: inherit;\n        opacity: 0.5;\n      }\n\n      [part=\"value\"]::-moz-placeholder {\n        color: inherit;\n        transition: opacity 0.175s 0.05s;\n        opacity: 0.5;\n      }\n\n      [part=\"value\"]::placeholder {\n        color: inherit;\n        transition: opacity 0.175s 0.1s;\n        opacity: 0.5;\n      }\n\n      [part=\"input-field\"] {\n        border-radius: var(--lumo-border-radius);\n        background-color: var(--lumo-contrast-10pct);\n        padding: 0 calc(0.375em + var(--lumo-border-radius) / 4 - 1px);\n        font-weight: 500;\n        line-height: 1;\n        position: relative;\n        cursor: text;\n        box-sizing: border-box;\n      }\n\n      /* Used for hover and activation effects */\n      [part=\"input-field\"]::after {\n        content: \"\";\n        position: absolute;\n        top: 0;\n        right: 0;\n        bottom: 0;\n        left: 0;\n        border-radius: inherit;\n        pointer-events: none;\n        background-color: var(--lumo-contrast-50pct);\n        opacity: 0;\n        transition: transform 0.15s, opacity 0.2s;\n        transform-origin: 100% 0;\n      }\n\n      /* Hover */\n\n      :host(:hover:not([readonly]):not([focused])) [part=\"label\"] {\n        color: var(--lumo-body-text-color);\n      }\n\n      :host(:hover:not([readonly]):not([focused])) [part=\"input-field\"]::after {\n        opacity: 0.1;\n      }\n\n      /* Touch device adjustment */\n      @media (pointer: coarse) {\n        :host(:hover:not([readonly]):not([focused])) [part=\"label\"] {\n          color: var(--lumo-secondary-text-color);\n        }\n\n        :host(:hover:not([readonly]):not([focused])) [part=\"input-field\"]::after {\n          opacity: 0;\n        }\n\n        :host(:active:not([readonly]):not([focused])) [part=\"input-field\"]::after {\n          opacity: 0.2;\n        }\n      }\n\n      /* Trigger when not focusing using the keyboard */\n      :host([focused]:not([focus-ring]):not([readonly])) [part=\"input-field\"]::after {\n        transform: scaleX(0);\n        transition-duration: 0.15s, 1s;\n      }\n\n      /* Focus-ring */\n\n      :host([focus-ring]) [part=\"input-field\"] {\n        box-shadow: 0 0 0 2px var(--lumo-primary-color-50pct);\n      }\n\n      /* Read-only and disabled */\n      :host([readonly]) [part=\"value\"]::-webkit-input-placeholder,\n      :host([disabled]) [part=\"value\"]::-webkit-input-placeholder {\n        opacity: 0;\n      }\n\n      :host([readonly]) [part=\"value\"]:-ms-input-placeholder,\n      :host([disabled]) [part=\"value\"]:-ms-input-placeholder {\n        opacity: 0;\n      }\n\n      :host([readonly]) [part=\"value\"]::-moz-placeholder,\n      :host([disabled]) [part=\"value\"]::-moz-placeholder {\n        opacity: 0;\n      }\n\n      :host([readonly]) [part=\"value\"]::placeholder,\n      :host([disabled]) [part=\"value\"]::placeholder {\n        opacity: 0;\n      }\n\n      /* Read-only */\n\n      :host([readonly]) [part=\"input-field\"] {\n        color: var(--lumo-secondary-text-color);\n        background-color: transparent;\n        cursor: default;\n      }\n\n      :host([readonly]) [part=\"input-field\"]::after {\n        background-color: transparent;\n        opacity: 1;\n        border: 1px dashed var(--lumo-contrast-30pct);\n      }\n\n      /* Disabled style */\n\n      :host([disabled]) {\n        pointer-events: none;\n      }\n\n      :host([disabled]) [part=\"input-field\"] {\n        background-color: var(--lumo-contrast-5pct);\n      }\n\n      :host([disabled]) [part=\"label\"],\n      :host([disabled]) [part=\"value\"],\n      :host([disabled]) [part=\"input-field\"] ::slotted(*) {\n        color: var(--lumo-disabled-text-color);\n        -webkit-text-fill-color: var(--lumo-disabled-text-color);\n      }\n\n      /* Invalid style */\n\n      :host([invalid]) [part=\"input-field\"] {\n        background-color: var(--lumo-error-color-10pct);\n      }\n\n      :host([invalid]) [part=\"input-field\"]::after {\n        background-color: var(--lumo-error-color-50pct);\n      }\n\n      :host([invalid][focus-ring]) [part=\"input-field\"] {\n        box-shadow: 0 0 0 2px var(--lumo-error-color-50pct);\n      }\n\n      :host([input-prevented]) [part=\"input-field\"] {\n        color: var(--lumo-error-text-color);\n      }\n\n      /* Small theme */\n\n      :host([theme~=\"small\"]) {\n        font-size: var(--lumo-font-size-s);\n        --lumo-text-field-size: var(--lumo-size-s);\n      }\n\n      :host([theme~=\"small\"][has-label]) [part=\"label\"] {\n        font-size: var(--lumo-font-size-xs);\n      }\n\n      :host([theme~=\"small\"][has-label]) [part=\"error-message\"] {\n        font-size: var(--lumo-font-size-xxs);\n      }\n\n      /* Text align */\n\n      :host([theme~=\"align-center\"]) [part=\"value\"] {\n        text-align: center;\n        --_lumo-text-field-overflow-mask-image: none;\n      }\n\n      :host([theme~=\"align-right\"]) [part=\"value\"] {\n        text-align: right;\n        --_lumo-text-field-overflow-mask-image: none;\n      }\n\n      @-moz-document url-prefix() {\n        /* Firefox is smart enough to align overflowing text to right */\n        :host([theme~=\"align-right\"]) [part=\"value\"] {\n          --_lumo-text-field-overflow-mask-image: linear-gradient(to right, transparent 0.25em, #000 1.5em);\n        }\n      }\n\n      /* Slotted content */\n\n      [part=\"input-field\"] ::slotted(:not([part]):not(iron-icon):not(input):not(textarea)) {\n        color: var(--lumo-secondary-text-color);\n        font-weight: 400;\n      }\n\n      /* Slotted icons */\n\n      [part=\"input-field\"] ::slotted(iron-icon) {\n        color: var(--lumo-contrast-60pct);\n        width: var(--lumo-icon-size-m);\n        height: var(--lumo-icon-size-m);\n      }\n\n      /* Vaadin icons are based on a 16x16 grid (unlike Lumo and Material icons with 24x24), so they look too big by default */\n      [part=\"input-field\"] ::slotted(iron-icon[icon^=\"vaadin:\"]) {\n        padding: 0.25em;\n        box-sizing: border-box !important;\n      }\n\n      [part=\"clear-button\"]::before {\n        content: var(--lumo-icons-cross);\n      }\n    </style>\n  </template>\n</dom-module>"]);_templateObject6_b3f198a064f911e99435bfcd8e03834f=function _templateObject6_b3f198a064f911e99435bfcd8e03834f(){return data};return data}function _templateObject5_b3f198a064f911e99435bfcd8e03834f(){var data=babelHelpers.taggedTemplateLiteral(["\n    <style include=\"vaadin-text-field-shared-styles\">\n      /* polymer-cli linter breaks with empty line */\n    </style>\n\n    <div class=\"vaadin-text-field-container\">\n\n      <label part=\"label\" on-click=\"focus\" id=\"[[_labelId]]\">[[label]]</label>\n\n      <div part=\"input-field\">\n\n        <slot name=\"prefix\"></slot>\n\n        <slot name=\"input\">\n          <input part=\"value\">\n        </slot>\n\n        <div part=\"clear-button\" id=\"clearButton\" role=\"button\" aria-label=\"Clear\"></div>\n        <slot name=\"suffix\"></slot>\n\n      </div>\n\n      <div part=\"error-message\" id=\"[[_errorId]]\" aria-live=\"assertive\" aria-hidden$=\"[[_getErrorMessageAriaHidden(invalid, errorMessage, _errorId)]]\">[[errorMessage]]</div>\n\n    </div>\n"],["\n    <style include=\"vaadin-text-field-shared-styles\">\n      /* polymer-cli linter breaks with empty line */\n    </style>\n\n    <div class=\"vaadin-text-field-container\">\n\n      <label part=\"label\" on-click=\"focus\" id=\"[[_labelId]]\">[[label]]</label>\n\n      <div part=\"input-field\">\n\n        <slot name=\"prefix\"></slot>\n\n        <slot name=\"input\">\n          <input part=\"value\">\n        </slot>\n\n        <div part=\"clear-button\" id=\"clearButton\" role=\"button\" aria-label=\"Clear\"></div>\n        <slot name=\"suffix\"></slot>\n\n      </div>\n\n      <div part=\"error-message\" id=\"[[_errorId]]\" aria-live=\"assertive\" aria-hidden\\$=\"[[_getErrorMessageAriaHidden(invalid, errorMessage, _errorId)]]\">[[errorMessage]]</div>\n\n    </div>\n"]);_templateObject5_b3f198a064f911e99435bfcd8e03834f=function _templateObject5_b3f198a064f911e99435bfcd8e03834f(){return data};return data}function _templateObject4_b3f198a064f911e99435bfcd8e03834f(){var data=babelHelpers.taggedTemplateLiteral(["<dom-module id=\"lumo-radio-group\" theme-for=\"vaadin-radio-group\">\n  <template>\n    <style include=\"lumo-required-field\">\n      :host {\n        color: var(--lumo-body-text-color);\n        font-size: var(--lumo-font-size-m);\n        font-family: var(--lumo-font-family);\n        -webkit-font-smoothing: antialiased;\n        -moz-osx-font-smoothing: grayscale;\n        -webkit-tap-highlight-color: transparent;\n        padding: var(--lumo-space-xs) 0;\n      }\n\n      :host::before {\n        height: var(--lumo-size-m);\n        box-sizing: border-box;\n        display: inline-flex;\n        align-items: center;\n      }\n\n      :host([theme~=\"vertical\"]) [part=\"group-field\"] {\n        display: flex;\n        flex-direction: column;\n      }\n\n      [part=\"label\"] {\n        padding-bottom: 0.7em;\n      }\n    </style>\n  </template>\n</dom-module>"]);_templateObject4_b3f198a064f911e99435bfcd8e03834f=function _templateObject4_b3f198a064f911e99435bfcd8e03834f(){return data};return data}function _templateObject3_b3f198a064f911e99435bfcd8e03834f(){var data=babelHelpers.taggedTemplateLiteral(["<dom-module id=\"lumo-radio-button\" theme-for=\"vaadin-radio-button\">\n  <template>\n    <style>\n      :host {\n        -webkit-tap-highlight-color: transparent;\n        -webkit-user-select: none;\n        -moz-user-select: none;\n        -ms-user-select: none;\n        user-select: none;\n        cursor: default;\n        outline: none;\n      }\n\n      [part=\"label\"]:not([empty]) {\n        margin: 0.1875em 0.875em 0.1875em 0.375em;\n      }\n\n      [part=\"radio\"] {\n        width: calc(1em + 2px);\n        height: calc(1em + 2px);\n        margin: 0.1875em;\n        position: relative;\n        border-radius: 50%;\n        background-color: var(--lumo-contrast-20pct);\n        transition: transform 0.2s cubic-bezier(.12, .32, .54, 2), background-color 0.15s;\n        pointer-events: none;\n        will-change: transform;\n        line-height: 1.2;\n        transform: translateZ(0); /* Workaround IE11 jumpiness */\n      }\n\n      /* Used for activation \"halo\" */\n      [part=\"radio\"]::before {\n        /* Needed to align the radio-button nicely on the baseline */\n        content: \"\\2003\";\n        color: transparent;\n        display: inline-block;\n        width: 100%;\n        height: 100%;\n        border-radius: inherit;\n        background-color: inherit;\n        transform: scale(1.4);\n        opacity: 0;\n        transition: transform 0.1s, opacity 0.8s;\n        will-change: transform, opacity;\n      }\n\n      /* Used for the dot */\n      [part=\"radio\"]::after {\n        content: \"\";\n        width: 0;\n        height: 0;\n        border: 3px solid var(--lumo-primary-contrast-color);\n        border-radius: 50%;\n        position: absolute;\n        top: 50%;\n        left: 50%;\n        transform: translate(-50%, -50%) scale(0);\n        transition: 0.25s transform;\n        will-change: transform;\n        background-clip: content-box;\n      }\n\n      :host([checked]) [part=\"radio\"] {\n        background-color: var(--lumo-primary-color);\n      }\n\n      :host([checked]) [part=\"radio\"]::after {\n        transform: translate(-50%, -50%) scale(1);\n      }\n\n      :host(:not([checked]):not([indeterminate]):not([disabled]):hover) [part=\"radio\"] {\n        background-color: var(--lumo-contrast-30pct);\n      }\n\n      :host([active]) [part=\"radio\"] {\n        transform: scale(0.9);\n        transition-duration: 0.05s;\n      }\n\n      :host([active][checked]) [part=\"radio\"] {\n        transform: scale(1.1);\n      }\n\n      :host([active]:not([checked])) [part=\"radio\"]::before {\n        transition-duration: 0.01s, 0.01s;\n        transform: scale(0);\n        opacity: 0.4;\n      }\n\n      :host([focus-ring]) [part=\"radio\"] {\n        box-shadow: 0 0 0 3px var(--lumo-primary-color-50pct);\n      }\n\n      :host([disabled]) {\n        pointer-events: none;\n        color: var(--lumo-disabled-text-color);\n      }\n\n      :host([disabled]) ::slotted(*) {\n        color: inherit;\n      }\n\n      :host([disabled]) [part=\"radio\"] {\n        background-color: var(--lumo-contrast-10pct);\n      }\n\n      :host([disabled]) [part=\"radio\"]::after {\n        border-color: var(--lumo-contrast-30pct);\n      }\n\n      /* IE11 only */\n      ::-ms-backdrop,\n      [part=\"radio\"] {\n        line-height: 1;\n      }\n    </style>\n  </template>\n</dom-module>"],["<dom-module id=\"lumo-radio-button\" theme-for=\"vaadin-radio-button\">\n  <template>\n    <style>\n      :host {\n        -webkit-tap-highlight-color: transparent;\n        -webkit-user-select: none;\n        -moz-user-select: none;\n        -ms-user-select: none;\n        user-select: none;\n        cursor: default;\n        outline: none;\n      }\n\n      [part=\"label\"]:not([empty]) {\n        margin: 0.1875em 0.875em 0.1875em 0.375em;\n      }\n\n      [part=\"radio\"] {\n        width: calc(1em + 2px);\n        height: calc(1em + 2px);\n        margin: 0.1875em;\n        position: relative;\n        border-radius: 50%;\n        background-color: var(--lumo-contrast-20pct);\n        transition: transform 0.2s cubic-bezier(.12, .32, .54, 2), background-color 0.15s;\n        pointer-events: none;\n        will-change: transform;\n        line-height: 1.2;\n        transform: translateZ(0); /* Workaround IE11 jumpiness */\n      }\n\n      /* Used for activation \"halo\" */\n      [part=\"radio\"]::before {\n        /* Needed to align the radio-button nicely on the baseline */\n        content: \"\\\\2003\";\n        color: transparent;\n        display: inline-block;\n        width: 100%;\n        height: 100%;\n        border-radius: inherit;\n        background-color: inherit;\n        transform: scale(1.4);\n        opacity: 0;\n        transition: transform 0.1s, opacity 0.8s;\n        will-change: transform, opacity;\n      }\n\n      /* Used for the dot */\n      [part=\"radio\"]::after {\n        content: \"\";\n        width: 0;\n        height: 0;\n        border: 3px solid var(--lumo-primary-contrast-color);\n        border-radius: 50%;\n        position: absolute;\n        top: 50%;\n        left: 50%;\n        transform: translate(-50%, -50%) scale(0);\n        transition: 0.25s transform;\n        will-change: transform;\n        background-clip: content-box;\n      }\n\n      :host([checked]) [part=\"radio\"] {\n        background-color: var(--lumo-primary-color);\n      }\n\n      :host([checked]) [part=\"radio\"]::after {\n        transform: translate(-50%, -50%) scale(1);\n      }\n\n      :host(:not([checked]):not([indeterminate]):not([disabled]):hover) [part=\"radio\"] {\n        background-color: var(--lumo-contrast-30pct);\n      }\n\n      :host([active]) [part=\"radio\"] {\n        transform: scale(0.9);\n        transition-duration: 0.05s;\n      }\n\n      :host([active][checked]) [part=\"radio\"] {\n        transform: scale(1.1);\n      }\n\n      :host([active]:not([checked])) [part=\"radio\"]::before {\n        transition-duration: 0.01s, 0.01s;\n        transform: scale(0);\n        opacity: 0.4;\n      }\n\n      :host([focus-ring]) [part=\"radio\"] {\n        box-shadow: 0 0 0 3px var(--lumo-primary-color-50pct);\n      }\n\n      :host([disabled]) {\n        pointer-events: none;\n        color: var(--lumo-disabled-text-color);\n      }\n\n      :host([disabled]) ::slotted(*) {\n        color: inherit;\n      }\n\n      :host([disabled]) [part=\"radio\"] {\n        background-color: var(--lumo-contrast-10pct);\n      }\n\n      :host([disabled]) [part=\"radio\"]::after {\n        border-color: var(--lumo-contrast-30pct);\n      }\n\n      /* IE11 only */\n      ::-ms-backdrop,\n      [part=\"radio\"] {\n        line-height: 1;\n      }\n    </style>\n  </template>\n</dom-module>"]);_templateObject3_b3f198a064f911e99435bfcd8e03834f=function _templateObject3_b3f198a064f911e99435bfcd8e03834f(){return data};return data}function _templateObject2_b3f198a064f911e99435bfcd8e03834f(){var data=babelHelpers.taggedTemplateLiteral(["\n    <style>\n      :host {\n        display: inline-flex;\n      }\n\n      :host::before {\n        content: \"\\2003\";\n        width: 0;\n        display: inline-block;\n      }\n\n      :host([hidden]) {\n        display: none !important;\n      }\n\n      .vaadin-group-field-container {\n        display: flex;\n        flex-direction: column;\n      }\n\n      [part=\"label\"]:empty {\n        display: none;\n      }\n    </style>\n\n    <div class=\"vaadin-group-field-container\">\n      <label part=\"label\">[[label]]</label>\n\n      <div part=\"group-field\">\n        <slot id=\"slot\"></slot>\n      </div>\n\n      <div part=\"error-message\" id=\"[[_errorId]]\" aria-live=\"assertive\" aria-hidden$=\"[[_getErrorMessageAriaHidden(invalid, errorMessage, _errorId)]]\">[[errorMessage]]</div>\n    </div>\n"],["\n    <style>\n      :host {\n        display: inline-flex;\n      }\n\n      :host::before {\n        content: \"\\\\2003\";\n        width: 0;\n        display: inline-block;\n      }\n\n      :host([hidden]) {\n        display: none !important;\n      }\n\n      .vaadin-group-field-container {\n        display: flex;\n        flex-direction: column;\n      }\n\n      [part=\"label\"]:empty {\n        display: none;\n      }\n    </style>\n\n    <div class=\"vaadin-group-field-container\">\n      <label part=\"label\">[[label]]</label>\n\n      <div part=\"group-field\">\n        <slot id=\"slot\"></slot>\n      </div>\n\n      <div part=\"error-message\" id=\"[[_errorId]]\" aria-live=\"assertive\" aria-hidden\\$=\"[[_getErrorMessageAriaHidden(invalid, errorMessage, _errorId)]]\">[[errorMessage]]</div>\n    </div>\n"]);_templateObject2_b3f198a064f911e99435bfcd8e03834f=function _templateObject2_b3f198a064f911e99435bfcd8e03834f(){return data};return data}function _templateObject_b3f198a064f911e99435bfcd8e03834f(){var data=babelHelpers.taggedTemplateLiteral(["\n    <style>\n      :host {\n        display: inline-block;\n      }\n\n      label {\n        display: inline-flex;\n        align-items: baseline;\n        outline: none;\n      }\n\n      [part=\"radio\"] {\n        position: relative;\n        display: inline-block;\n        flex: none;\n      }\n\n      input[type=\"radio\"] {\n        position: absolute;\n        top: 0;\n        left: 0;\n        width: 100%;\n        height: 100%;\n        opacity: 0;\n        cursor: inherit;\n        margin: 0;\n      }\n\n      :host([disabled]) {\n        -webkit-tap-highlight-color: transparent;\n      }\n    </style>\n\n    <label>\n      <span part=\"radio\">\n        <input type=\"radio\" checked=\"{{checked::change}}\" disabled$=\"[[disabled]]\" role=\"presentation\" on-change=\"_onChange\" tabindex=\"-1\">\n      </span>\n\n      <span part=\"label\">\n        <slot></slot>\n      </span>\n    </label>\n"],["\n    <style>\n      :host {\n        display: inline-block;\n      }\n\n      label {\n        display: inline-flex;\n        align-items: baseline;\n        outline: none;\n      }\n\n      [part=\"radio\"] {\n        position: relative;\n        display: inline-block;\n        flex: none;\n      }\n\n      input[type=\"radio\"] {\n        position: absolute;\n        top: 0;\n        left: 0;\n        width: 100%;\n        height: 100%;\n        opacity: 0;\n        cursor: inherit;\n        margin: 0;\n      }\n\n      :host([disabled]) {\n        -webkit-tap-highlight-color: transparent;\n      }\n    </style>\n\n    <label>\n      <span part=\"radio\">\n        <input type=\"radio\" checked=\"{{checked::change}}\" disabled\\$=\"[[disabled]]\" role=\"presentation\" on-change=\"_onChange\" tabindex=\"-1\">\n      </span>\n\n      <span part=\"label\">\n        <slot></slot>\n      </span>\n    </label>\n"]);_templateObject_b3f198a064f911e99435bfcd8e03834f=function _templateObject_b3f198a064f911e99435bfcd8e03834f(){return data};return data}var nativeShadow=!(window.ShadyDOM&&window.ShadyDOM.inUse);_exports.nativeShadow=nativeShadow;var nativeCssVariables_;/**
...
properties.tabIndex=properties.tabindex}return properties}}]);return VaadinTabIndexMixin}(superClass))},ControlStateMixin=function ControlStateMixin(superClass){return(/*#__PURE__*/function(_TabIndexMixin){babelHelpers.inherits(VaadinControlStateMixin,_TabIndexMixin);function VaadinControlStateMixin(){babelHelpers.classCallCheck(this,VaadinControlStateMixin);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(VaadinControlStateMixin).apply(this,arguments))}babelHelpers.createClass(VaadinControlStateMixin,[{key:"ready",value:function ready(){var _this34=this;this.addEventListener("focusin",function(e){if(e.composedPath()[0]===_this34){_this34._focus(e)}else if(-1!==e.composedPath().indexOf(_this34.focusElement)&&!_this34.disabled){_this34._setFocused(!0)}});this.addEventListener("focusout",function(e){return _this34._setFocused(!1)});// In super.ready() other 'focusin' and 'focusout' listeners might be
...
_this34._isShiftTabbing=!0;HTMLElement.prototype.focus.apply(_this34);_this34._setFocused(!1);// Event handling in IE is asynchronous and the flag is removed asynchronously as well
setTimeout(function(){return _this34._isShiftTabbing=!1},0)}else{// Workaround for FF63-65 bug that causes the focus to get lost when
// blurring a slotted component with focusable shadow root content
// https://bugzilla.mozilla.org/show_bug.cgi?id=1528686
// TODO: Remove when safe
var firefox=window.navigator.userAgent.match(/Firefox\/(\d\d\.\d)/);if(firefox&&63<=parseFloat(firefox[1])&&66>parseFloat(firefox[1])&&_this34.parentNode&&_this34.nextSibling){var fakeTarget=document.createElement("input");fakeTarget.style.position="absolute";fakeTarget.style.opacity=0;fakeTarget.tabIndex=_this34.tabIndex;_this34.parentNode.insertBefore(fakeTarget,_this34.nextSibling);fakeTarget.focus();fakeTarget.addEventListener("focusout",function(){return _this34.parentNode.removeChild(fakeTarget)})}}}});if(this.autofocus&&!this.focused&&!this.disabled){window.requestAnimationFrame(function(){_this34._focus();_this34._setFocused(!0);_this34.setAttribute("focus-ring","")})}this._boundKeydownListener=this._bodyKeydownListener.bind(this);this._boundKeyupListener=this._bodyKeyupListener.bind(this)}/**
     * @protected
...
if(-1!==this.tabindex){this._previousTabIndex=this.tabindex}this.tabindex=tabindex=void 0}if(window.ShadyDOM){this.setProperties({tabIndex:tabindex,tabindex:tabindex})}}/**
    ...
    * @polymerMixin
    */_exports.ControlStateMixin=ControlStateMixin;var vaadinControlStateMixin={ControlStateMixin:ControlStateMixin};_exports.$vaadinControlStateMixin=vaadinControlStateMixin;var DEV_MODE_CODE_REGEXP=/\/\*\*\s+vaadin-dev-mode:start([\s\S]*)vaadin-dev-mode:end\s+\*\*\//i;function isMinified(){function test(){/** vaadin-dev-mode:start
    return false;
...
return 0}}).forEach(function(moduleName){if(moduleName!==defaultModuleName){var themeFor=modules[moduleName].getAttribute("theme-for");if(themeFor){themeFor.split(" ").forEach(function(themeForToken){if(new RegExp("^"+themeForToken.split("*").join(".*")+"$").test(_this36.is)){hasThemes=!0;_this36._includeStyle(moduleName,template)}})}}});if(!hasThemes&&modules[defaultModuleName]){// No theme modules found, include the default module if it exists
this._includeStyle(defaultModuleName,template)}}/** @private */},{key:"_includeStyle",value:function _includeStyle(moduleName,template){if(template&&!template.content.querySelector("style[include=\"".concat(moduleName,"\"]"))){var styleEl=document.createElement("style");styleEl.setAttribute("include",moduleName);template.content.appendChild(styleEl)}}}]);return VaadinThemableMixin}(ThemePropertyMixin(superClass)))};_exports.ThemableMixin=ThemableMixin;var vaadinThemableMixin={ThemableMixin:ThemableMixin};_exports.$vaadinThemableMixin=vaadinThemableMixin;var RadioButtonElement=/*#__PURE__*/function(_ElementMixin$){babelHelpers.inherits(RadioButtonElement,_ElementMixin$);babelHelpers.createClass(RadioButtonElement,null,[{key:"template",get:function get(){return html(_templateObject_b3f198a064f911e99435bfcd8e03834f())}},{key:"is",get:function get(){return"vaadin-radio-button"}},{key:"version",get:function get(){return"1.2.0"}},{key:"properties",get:function get(){return{/**
       * True if the radio button is checked.
       */checked:{type:Boolean,value:!1,notify:!0,observer:"_checkedChanged",reflectToAttribute:!0},/**
       * The value for this element.
       */value:{type:String,value:"on"}}}}]);function RadioButtonElement(){var _this37;babelHelpers.classCallCheck(this,RadioButtonElement);_this37=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(RadioButtonElement).call(this));/**
              * @type {string}
              * Name of the element.
              */_this37.name;return _this37}babelHelpers.createClass(RadioButtonElement,[{key:"ready",value:function ready(){babelHelpers.get(babelHelpers.getPrototypeOf(RadioButtonElement.prototype),"ready",this).call(this);this.setAttribute("role","radio");this._addActiveListeners();var attrName=this.getAttribute("name");if(attrName){this.name=attrName}this.shadowRoot.querySelector("[part~=\"label\"]").querySelector("slot").addEventListener("slotchange",this._updateLabelAttribute.bind(this));this._updateLabelAttribute()}},{key:"_updateLabelAttribute",value:function _updateLabelAttribute(){var label=this.shadowRoot.querySelector("[part~=\"label\"]"),assignedNodes=label.firstElementChild.assignedNodes();if(this._isAssignedNodesEmpty(assignedNodes)){label.setAttribute("empty","")}else{label.removeAttribute("empty")}}},{key:"_isAssignedNodesEmpty",value:function _isAssignedNodesEmpty(nodes){// The assigned nodes considered to be empty if there is no slotted content or only one empty text node
return 0===nodes.length||1==nodes.length&&nodes[0].nodeType==Node.TEXT_NODE&&""===nodes[0].textContent.trim()}},{key:"_checkedChanged",value:function _checkedChanged(checked){this.setAttribute("aria-checked",checked)}},{key:"_addActiveListeners",value:function _addActiveListeners(){var _this38=this;this._addEventListenerToNode(this,"down",function(e){if(!_this38.disabled){_this38.setAttribute("active","")}});this._addEventListenerToNode(this,"up",function(e){_this38.removeAttribute("active")});this.addEventListener("keydown",function(e){if(!_this38.disabled&&32===e.keyCode){e.preventDefault();_this38.setAttribute("active","")}});this.addEventListener("keyup",function(e){if(!_this38.disabled&&32===e.keyCode){e.preventDefault();_this38.click();_this38.removeAttribute("active")}})}/**
     * Toggles the radio button, so that the native `change` event
     * is dispatched. Overrides the standard `HTMLElement.prototype.click`.
     * @protected
     */},{key:"click",value:function click(){this.shadowRoot.querySelector("input").click()}/** @protected */},{key:"_onChange",value:function _onChange(e){// In the Shadow DOM, the `change` event is not leaked into the
// ancestor tree, so we must do this manually.
var changeEvent=new CustomEvent("change",{detail:{sourceEvent:e},bubbles:e.bubbles,cancelable:e.cancelable});this.dispatchEvent(changeEvent)}},{key:"name",get:function get(){return this.checked?this._storedName:""},set:function set(name){this._storedName=name}},{key:"focusElement",get:function get(){return this.shadowRoot.querySelector("input")}}]);return RadioButtonElement}(ElementMixin$1(ControlStateMixin(ThemableMixin(GestureEventListeners(PolymerElement)))));/**
   * Fired when the user toggles the radio button.
   *
   * @event change
   */_exports.RadioButtonElement=RadioButtonElement;customElements.define(RadioButtonElement.is,RadioButtonElement);var vaadinRadioButton={RadioButtonElement:RadioButtonElement};_exports.$vaadinRadioButton=vaadinRadioButton;var RadioGroupElement=/*#__PURE__*/function(_ThemableMixin){babelHelpers.inherits(RadioGroupElement,_ThemableMixin);function RadioGroupElement(){babelHelpers.classCallCheck(this,RadioGroupElement);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(RadioGroupElement).apply(this,arguments))}babelHelpers.createClass(RadioGroupElement,[{key:"ready",value:function ready(){var _this39=this;babelHelpers.get(babelHelpers.getPrototypeOf(RadioGroupElement.prototype),"ready",this).call(this);this._addActiveListeners();this._observer=new FlattenedNodesObserver(this,function(info){var checkedChangedListener=function checkedChangedListener(e){if(e.target.checked){_this39._changeSelectedButton(e.target)}};// reverse() is used to set the last checked radio button value to radio group value
_this39._filterRadioButtons(info.addedNodes).reverse().forEach(function(button){button.addEventListener("checked-changed",checkedChangedListener);if(_this39.disabled){button.disabled=!0}if(button.checked){_this39._changeSelectedButton(button)}});_this39._filterRadioButtons(info.removedNodes).forEach(function(button){button.removeEventListener("checked-changed",checkedChangedListener);if(button.checked){_this39.value=void 0}})});if(this._radioButtons.length){this._setFocusable(0)}this.setAttribute("role","radiogroup");// Need to check e.composed as a workaround for https://bugzilla.mozilla.org/show_bug.cgi?id=1472887
// otherwise FF runs validation on keyboard focus
this.addEventListener("focusout",function(e){return e.composed&&_this39.validate()});var uniqueId=RadioGroupElement._uniqueId=1+RadioGroupElement._uniqueId||0;this._errorId="".concat(this.constructor.is,"-error-").concat(uniqueId)}},{key:"_filterRadioButtons",value:function _filterRadioButtons(nodes){return Array.from(nodes).filter(function(child){return babelHelpers.instanceof(child,RadioButtonElement)})}},{key:"_disabledChanged",value:function _disabledChanged(disabled){this.setAttribute("aria-disabled",disabled);this._updateDisableButtons()}},{key:"_updateDisableButtons",value:function _updateDisableButtons(){var _this40=this;this._radioButtons.forEach(function(button){if(_this40.disabled){button.disabled=!0}else if(_this40.readonly){// it's not possible to set readonly to radio buttons, but we can
// unchecked ones instead.
button.disabled=button!==_this40._checkedButton&&_this40.readonly}else{button.disabled=!1}})}},{key:"_readonlyChanged",value:function _readonlyChanged(newV,oldV){(newV||oldV)&&this._updateDisableButtons()}},{key:"_addActiveListeners",value:function _addActiveListeners(){var _this41=this;this.addEventListener("keydown",function(e){// if e.target is vaadin-radio-group then assign to checkedRadioButton currently checked radio button
var checkedRadioButton=e.target==_this41?_this41._checkedButton:e.target;// LEFT, UP - select previous radio button
if(37===e.keyCode||38===e.keyCode){e.preventDefault();_this41._selectPreviousButton(checkedRadioButton)}// RIGHT, DOWN - select next radio button
if(39===e.keyCode||40===e.keyCode){e.preventDefault();_this41._selectNextButton(checkedRadioButton)}})}},{key:"_selectButton",value:function _selectButton(element,setFocusRing){if(this._containsFocus()){element.focus();if(setFocusRing){element.setAttribute("focus-ring","")}}this._changeSelectedButton(element,setFocusRing)}},{key:"_containsFocus",value:function _containsFocus(){var root=this.getRootNode(),activeElement=root._activeElement!==void 0?root._activeElement:root.activeElement;// Safari 9 needs polyfilled `_activeElement` to return correct node
return this.contains(activeElement)}},{key:"_hasEnabledButtons",value:function _hasEnabledButtons(){return!this._radioButtons.every(function(button){return button.disabled})}},{key:"_selectNextButton",value:function _selectNextButton(element){if(!this._hasEnabledButtons()){return}var nextButton=element.nextElementSibling||this.firstElementChild;if(nextButton.disabled){this._selectNextButton(nextButton)}else{this._selectButton(nextButton,!0)}}},{key:"_selectPreviousButton",value:function _selectPreviousButton(element){if(!this._hasEnabledButtons()){return}var previousButton=element.previousElementSibling||this.lastElementChild;if(previousButton.disabled){this._selectPreviousButton(previousButton)}else{this._selectButton(previousButton,!0)}}},{key:"_changeSelectedButton",value:function _changeSelectedButton(button,fireChangeEvent){var _this42=this;if(this._checkedButton===button){return}this._checkedButton=button;this._radioButtons.forEach(function(button){if(button===_this42._checkedButton){if(fireChangeEvent){button.click()}else{button.checked=!0}}else{button.checked=!1}});if(this._checkedButton){this.value=this._checkedButton.value}this.validate();this.readonly&&this._updateDisableButtons();button&&this._setFocusable(this._radioButtons.indexOf(button))}},{key:"_valueChanged",value:function _valueChanged(newV,oldV){if(oldV&&(""===newV||null===newV||newV===void 0)){this._changeSelectedButton(null);this.removeAttribute("has-value");return}if(!this._checkedButton||newV!=this._checkedButton.value){var newCheckedButton=this._radioButtons.filter(function(button){return button.value==newV})[0];if(newCheckedButton){this._selectButton(newCheckedButton);this.setAttribute("has-value","")}else{console.warn("No <vaadin-radio-button> with value ".concat(newV," found."))}}}/**
     ...
     * @returns {boolean}
     */},{key:"checkValidity",value:function checkValidity(){return!this.required||!!this.value}},{key:"_setFocusable",value:function _setFocusable(idx){var items=this._radioButtons;items.forEach(function(e){return e.tabindex=e===items[idx]?0:-1})}},{key:"_labelChanged",value:function _labelChanged(label){if(label){this.setAttribute("has-label","")}else{this.removeAttribute("has-label")}}},{key:"_getActiveErrorId",value:function _getActiveErrorId(invalid,errorMessage,errorId){return errorMessage&&invalid?errorId:void 0}},{key:"_getErrorMessageAriaHidden",value:function _getErrorMessageAriaHidden(invalid,errorMessage,errorId){return(!this._getActiveErrorId(invalid,errorMessage,errorId)).toString()}},{key:"_radioButtons",get:function get(){return this._filterRadioButtons(this.querySelectorAll("*"))}}],[{key:"template",get:function get(){return html(_templateObject2_b3f198a064f911e99435bfcd8e03834f())}},{key:"is",get:function get(){return"vaadin-radio-group"}},{key:"properties",get:function get(){return{/**
       ...
       */value:{type:String,notify:!0,observer:"_valueChanged"}}}}]);return RadioGroupElement}(ThemableMixin(PolymerElement));_exports.RadioGroupElement=RadioGroupElement;customElements.define(RadioGroupElement.is,RadioGroupElement);var vaadinRadioGroup={RadioGroupElement:RadioGroupElement};_exports.$vaadinRadioGroup=vaadinRadioGroup;var $_documentContainer$8=html(_templateObject3_b3f198a064f911e99435bfcd8e03834f());document.head.appendChild($_documentContainer$8.content);var $_documentContainer$9=html(_templateObject4_b3f198a064f911e99435bfcd8e03834f());document.head.appendChild($_documentContainer$9.content);var $_documentContainer$a=document.createElement("template");$_documentContainer$a.innerHTML="<dom-module id=\"vaadin-text-field-shared-styles\">\n  <template>\n    <style>\n      :host {\n        display: inline-flex;\n        outline: none;\n      }\n\n      :host::before {\n        content: \"\\2003\";\n        width: 0;\n        display: inline-block;\n        /* Size and position this element on the same vertical position as the input-field element\n           to make vertical align for the host element work as expected */\n      }\n\n      :host([hidden]) {\n        display: none !important;\n      }\n\n      .vaadin-text-field-container,\n      .vaadin-text-area-container {\n        display: flex;\n        flex-direction: column;\n        min-width: 100%;\n        max-width: 100%;\n        width: var(--vaadin-text-field-default-width, 12em);\n      }\n\n      [part=\"label\"]:empty {\n        display: none;\n      }\n\n      [part=\"input-field\"] {\n        display: flex;\n        align-items: center;\n        flex: auto;\n      }\n\n      .vaadin-text-field-container [part=\"input-field\"] {\n        flex-grow: 0;\n      }\n\n      /* Reset the native input styles */\n      [part=\"value\"],\n      [part=\"input-field\"] ::slotted(input),\n      [part=\"input-field\"] ::slotted(textarea) {\n        -webkit-appearance: none;\n        -moz-appearance: none;\n        outline: none;\n        margin: 0;\n        padding: 0;\n        border: 0;\n        border-radius: 0;\n        min-width: 0;\n        font: inherit;\n        font-size: 1em;\n        line-height: normal;\n        color: inherit;\n        background-color: transparent;\n        /* Disable default invalid style in Firefox */\n        box-shadow: none;\n      }\n\n      [part=\"input-field\"] ::slotted(*) {\n        flex: none;\n      }\n\n      [part=\"value\"],\n      [part=\"input-field\"] ::slotted(input),\n      [part=\"input-field\"] ::slotted(textarea),\n      /* Slotted by vaadin-select-text-field */\n      [part=\"input-field\"] ::slotted([part=\"value\"]) {\n        flex: auto;\n        white-space: nowrap;\n        overflow: hidden;\n        width: 100%;\n        height: 100%;\n      }\n\n      [part=\"input-field\"] ::slotted(textarea) {\n        resize: none;\n      }\n\n      [part=\"value\"]::-ms-clear,\n      [part=\"input-field\"] ::slotted(input)::-ms-clear {\n        display: none;\n      }\n\n      [part=\"clear-button\"] {\n        cursor: default;\n      }\n\n      [part=\"clear-button\"]::before {\n        content: \"\u2715\";\n      }\n    </style>\n  </template>\n</dom-module>";document.head.appendChild($_documentContainer$a.content);var HOST_PROPS={default:["list","autofocus","pattern","autocapitalize","autocorrect","maxlength","minlength","name","placeholder","autocomplete","title"],accessible:["disabled","readonly","required","invalid"]},PROP_TYPE={DEFAULT:"default",ACCESSIBLE:"accessible"},TextFieldMixin=function TextFieldMixin(subclass){return(/*#__PURE__*/function(_ControlStateMixin){babelHelpers.inherits(VaadinTextFieldMixin,_ControlStateMixin);function VaadinTextFieldMixin(){babelHelpers.classCallCheck(this,VaadinTextFieldMixin);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(VaadinTextFieldMixin).apply(this,arguments))}babelHelpers.createClass(VaadinTextFieldMixin,[{key:"_onInput",value:function _onInput(e){var _this43=this;if(this.__preventInput){e.stopImmediatePropagation();this.__preventInput=!1;return}if(this.preventInvalidInput){var input=this.inputElement;if(0<input.value.length&&!this.checkValidity()){input.value=this.value||"";// add input-prevented attribute for 200ms
this.setAttribute("input-prevented","");this._inputDebouncer=Debouncer.debounce(this._inputDebouncer,timeOut.after(200),function(){_this43.removeAttribute("input-prevented")});return}}this.__userInput=!0;this.value=e.target.value}// NOTE(yuriy): Workaround needed for IE11 and Edge for proper displaying
...
return old!==value&&(old===old||value===value)};_exports.notEqual$1=_exports.notEqual=notEqual;var defaultPropertyDeclaration={attribute:!0,type:String,converter:defaultConverter,reflect:!1,hasChanged:notEqual},microtaskPromise=Promise.resolve(!0),STATE_HAS_UPDATED=1,STATE_UPDATE_REQUESTED=1<<2,STATE_IS_REFLECTING_TO_ATTRIBUTE=1<<3,STATE_IS_REFLECTING_TO_PROPERTY=1<<4,STATE_HAS_CONNECTED=1<<5,UpdatingElement=/*#__PURE__*/function(_HTMLElement4){babelHelpers.inherits(UpdatingElement,_HTMLElement4);function UpdatingElement(){var _this49;babelHelpers.classCallCheck(this,UpdatingElement);_this49=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(UpdatingElement).call(this));_this49._updateState=0;_this49._instanceProperties=void 0;_this49._updatePromise=microtaskPromise;_this49._hasConnectedResolver=void 0;/**
                                             * Map with keys for any properties that have changed since the last
                                             * update cycle with previous values.
                                             */_this49._changedProperties=new Map;/**
                                          * Map with keys of properties that should be reflected when updated.
                                          */_this49._reflectingProperties=void 0;_this49.initialize();return _this49}/**
...
this._requestUpdate()}/**
     ...
     */},{key:"_saveInstanceProperties",value:function _saveInstanceProperties(){var _this50=this;// Use forEach so this works even if for/of loops are compiled to for loops
// expecting arrays
this.constructor._classProperties.forEach(function(_v,p){if(_this50.hasOwnProperty(p)){var value=_this50[p];delete _this50[p];if(!_this50._instanceProperties){_this50._instanceProperties=new Map}_this50._instanceProperties.set(p,value)}})}/**
     * Applies previously saved instance properties.
     */},{key:"_applyInstanceProperties",value:function _applyInstanceProperties(){var _this51=this;// Use forEach so this works even if for/of loops are compiled to for loops
// expecting arrays
// tslint:disable-next-line:no-any
this._instanceProperties.forEach(function(v,p){return _this51[p]=v});this._instanceProperties=void 0}},{key:"connectedCallback",value:function connectedCallback(){this._updateState=this._updateState|STATE_HAS_CONNECTED;// Ensure first connection completes an update. Updates cannot complete before
...
this._markUpdated()}if(shouldUpdate){if(!(this._updateState&STATE_HAS_UPDATED)){this._updateState=this._updateState|STATE_HAS_UPDATED;this.firstUpdated(changedProperties)}this.updated(changedProperties)}}},{key:"_markUpdated",value:function _markUpdated(){this._changedProperties=new Map;this._updateState=this._updateState&~STATE_UPDATE_REQUESTED}/**
     ...
     *
     * * @param _changedProperties Map of changed properties with old values
     */},{key:"update",value:function update(_changedProperties){var _this53=this;if(this._reflectingProperties!==void 0&&0<this._reflectingProperties.size){// Use forEach so this works even if for/of loops are compiled to for
// loops expecting arrays
this._reflectingProperties.forEach(function(v,k){return _this53._propertyToAttribute(k,_this53[k],v)});this._reflectingProperties=void 0}}/**
     ...
     */ /** @nocollapse */value:function _ensureClassProperties(){var _this54=this;// ensure private storage for property declarations.
...
var superProperties=Object.getPrototypeOf(this)._classProperties;if(superProperties!==void 0){superProperties.forEach(function(v,k){return _this54._classProperties.set(k,v)})}}}/**
...
if(null===node.previousSibling||index===lastPartIndex){index++;_parent.insertBefore(createMarker(),node)}lastPartIndex=index;_this56.parts.push({type:"node",index:index});// If we don't have a nextSibling, keep this node so we have an end.
...
_this56.parts.push({type:"node",index:-1})}}}}};_prepareTemplate(element);// Remove text binding nodes after the walk to not disturb the TreeWalker
for(var _arr=nodesToRemove,_i79=0,n;_i79<_arr.length;_i79++){n=_arr[_i79];n.parentNode.removeChild(n)}};_exports.Template$1=_exports.Template=Template;var isTemplatePartActive=function isTemplatePartActive(part){return-1!==part.index};// Allows `document.createComment('')` to be renamed for a
...
itemParts.length=partIndex;this.clear(itemPart&&itemPart.endNode)}}},{key:"clear",value:function clear(){var startNode=0<arguments.length&&arguments[0]!==void 0?arguments[0]:this.startNode;removeNodes(this.startNode.parentNode,startNode.nextSibling,this.endNode)}}]);return NodePart}();/**
   ...
   * a string first.
   */_exports.BooleanAttributePart$1=_exports.BooleanAttributePart=BooleanAttributePart;var PropertyCommitter=/*#__PURE__*/function(_AttributeCommitter){babelHelpers.inherits(PropertyCommitter,_AttributeCommitter);function PropertyCommitter(element,name,strings){var _this58;babelHelpers.classCallCheck(this,PropertyCommitter);_this58=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(PropertyCommitter).call(this,element,name,strings));_this58.single=2===strings.length&&""===strings[0]&&""===strings[1];return _this58}babelHelpers.createClass(PropertyCommitter,[{key:"_createPart",value:function _createPart(){return new PropertyPart(this)}},{key:"_getValue",value:function _getValue(){if(this.single){return this.parts[0].value}return babelHelpers.get(babelHelpers.getPrototypeOf(PropertyCommitter.prototype),"_getValue",this).call(this)}},{key:"commit",value:function commit(){if(this.dirty){this.dirty=!1;// tslint:disable-next-line:no-any
...
for(var condensedStyle=document.createElement("style"),_i84=0,style;_i84<styles.length;_i84++){style=styles[_i84];style.parentNode.removeChild(style);condensedStyle.textContent+=style.textContent}// Remove styles from nested templates in this scope.
...
styleSet.forEach(function(v){return styles.unshift(v)})}else if(userStyles){styles.push(userStyles)}return styles}}]);return LitElement}(UpdatingElement);_exports.LitElement=LitElement;/**
   ...
   */LitElement.finalized=!0;/**
                              ...
                              * @nocollapse
                              */LitElement.render=render$2;var litElement={LitElement:LitElement,defaultConverter:defaultConverter,notEqual:notEqual,UpdatingElement:UpdatingElement,customElement:customElement,property:property,query:query,queryAll:queryAll,eventOptions:eventOptions,html:html$1,svg:svg,TemplateResult:TemplateResult,SVGTemplateResult:SVGTemplateResult,supportsAdoptingStyleSheets:supportsAdoptingStyleSheets,CSSResult:CSSResult,unsafeCSS:unsafeCSS,css:css};_exports.$litElement=litElement;var VisibilityFilters={SHOW_SEGMENT:"Segment",SHOW_NUMBERS:"Numbers"},TodoView=/*#__PURE__*/function(_LitElement){babelHelpers.inherits(TodoView,_LitElement);babelHelpers.createClass(TodoView,null,[{key:"properties",get:function get(){return{task:{type:String},suttaData:{type:String},filter:{type:String}}}}]);function TodoView(){var _this61;babelHelpers.classCallCheck(this,TodoView);_this61=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(TodoView).call(this));_this61.task="";_this61.suttaData="Enter a sutta number and press ENTER";_this61.filter=VisibilityFilters.SHOW_SEGMENT;return _this61}babelHelpers.createClass(TodoView,[{key:"connectedCallback",value:function connectedCallback(){babelHelpers.get(babelHelpers.getPrototypeOf(TodoView.prototype),"connectedCallback",this).call(this)}},{key:"render",value:function render(){return html$1(_templateObject7_b3f198a064f911e99435bfcd8e03834f(),this.shortcutListener,this.task,this.updateTask,this.filter,this.filterChanged,Object.values(VisibilityFilters).map(function(filter){return html$1(_templateObject8_b3f198a064f911e99435bfcd8e03834f(),filter,filter)}),this.suttaData)}},{key:"updateTask",value:function updateTask(e){this.task=e.target.value}},{key:"shortcutListener",value:function shortcutListener(e){if("Enter"===e.key){this.applyFilter()}}},{key:"filterChanged",value:function filterChanged(e){this.filter=e.target.value;this.task?this.applyFilter():""}},{key:"applyFilter",value:function applyFilter(){var _this62=this,url="suttas/".concat(this.task,".json");if(this.filter==VisibilityFilters.SHOW_NUMBERS){fetch(url).then(function(r){return r.json()}).then(function(data){_this62.buildSegTable(data)})}else{fetch(url).then(function(r){return r.json()}).then(function(data){_this62.buildTable(data)})}}},{key:"buildTable",value:function buildTable(data){var suttaItem="";suttaItem=html$1(_templateObject9_b3f198a064f911e99435bfcd8e03834f(),suttaItem,this.task,this.task);for(var _i86=1,parallelsItems;_i86<data.length;_i86++){parallelsItems="";for(var _p17=0;_p17<data[_i86].parallels.length;_p17++){var parSegmentRef=data[_i86].parallels[_p17].parsegnr,parSutta=parSegmentRef?parSegmentRef.split(":"):[];parallelsItems=html$1(_templateObject10_b3f198a064f911e99435bfcd8e03834f(),parallelsItems,parSutta[0],parSutta[1],parSegmentRef,data[_i86].parallels[_p17].probability,data[_i86].parallels[_p17].parsegment)}suttaItem=html$1(_templateObject11_b3f198a064f911e99435bfcd8e03834f(),suttaItem,data[_i86].parallels.length+1,this.task,data[_i86].segmentnr,data[_i86].segmentnr,data[_i86].segment,parallelsItems)}this.suttaData=suttaItem}},{key:"buildSegTable",value:function buildSegTable(data){var suttaItem="",collectionkeys=["dn","mn","sn","an","dhp","ud","iti","snp","vv","pv","thag","thig","ja","mnd","cnd","ne","pe","mil","other"];suttaItem=html$1(_templateObject12_b3f198a064f911e99435bfcd8e03834f(),suttaItem,this.task,this.addHeader(collectionkeys));for(var _i87=1,collections;_i87<data.length;_i87++){collections={dn:[],mn:[],sn:[],an:[],dhp:[],ud:[],iti:[],snp:[],vv:[],pv:[],thag:[],thig:[],ja:[],mnd:[],cnd:[],ne:[],pe:[],mil:[],other:[]};for(var _p18=0;_p18<data[_i87].parallels.length;_p18++){var parSegmentRef=data[_i87].parallels[_p18].parsegnr,parSutta=parSegmentRef?parSegmentRef.split(":"):[],parCollection=parSutta[0].match(/[a-z\-]*/g)[0];if(collections["".concat(parCollection)]){collections["".concat(parCollection)].push(parSutta)}else{collections.other.push(parSutta)}}suttaItem=html$1(_templateObject13_b3f198a064f911e99435bfcd8e03834f(),suttaItem,this.task,data[_i87].segmentnr,data[_i87].segmentnr,this.addParallelItems(collections))}this.suttaData=suttaItem}},{key:"addParallelItems",value:function addParallelItems(collections){if(!collections){return}for(var keys=Object.keys(collections),parallelsItemsTable="",_arr2=keys,_i88=0,key;_i88<_arr2.length;_i88++){key=_arr2[_i88];parallelsItemsTable=html$1(_templateObject14_b3f198a064f911e99435bfcd8e03834f(),parallelsItemsTable,this.addParallels(collections[key]))}return parallelsItemsTable}},{key:"addParallels",value:function addParallels(inputArray){var parallelInput="";inputArray.forEach(function(item){parallelInput=html$1(_templateObject15_b3f198a064f911e99435bfcd8e03834f(),parallelInput,item[0],item[1],item[0],item[1])});return parallelInput}},{key:"addHeader",value:function addHeader(inputKeys){var header="";inputKeys.forEach(function(item){header=html$1(_templateObject16_b3f198a064f911e99435bfcd8e03834f(),header,item.toUpperCase())});return header}}]);return TodoView}(LitElement);customElements.define("todo-view",TodoView)});